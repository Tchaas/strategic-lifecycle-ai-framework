          ...
          <Card className="rounded-md border-cyan-500/50 bg-slate-900 text-slate-100">
            ...
            <CardContent className="space-y-5">
              ...
              <form className="grid gap-5" onSubmit={saveObjective}>
                ...
                <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end"><Button type="button" variant="outline" onClick={resetForm} className="rounded-sm bg-lime-500 text-black hover:bg-lime-400">Clear</Button><Button type="submit" disabled={hasReachedLimit} className="rounded-sm bg-lime-500 text-black hover:bg-lime-400 disabled:opacity-50"><Save className="mr-2 h-4 w-4" />{editingId ? 'Update Objective' : 'Save Objective'}</Button></div>
              </form>
            </CardContent>
          </Card>
